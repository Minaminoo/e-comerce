...
const product2 = () => {
  ...
  const cartAmount = cartItem[2];
        return ( <div> 
          <h1 className="product-head">Pop-Up Toaster</h1> 
          <div className="product"> 
          <div><img src="/images/products/Pop-Up Toaster.jpg" alt="Little Armchair Sheepskin" className="product-image product-image-mobile" />
          </div> 
          <div className="product-inf"> 
            ...
            <button className="addToCart-btn" onClick={() => addToCart(2)}> ADD TO CART{cartAmount > 0 && <>({cartAmount})</>}</button> 
            ...
            <div className="product-sub-test"> 
              ...
              <p className="product-information">3.5kg</p> </div> 
            <div className="product-sub-test"> <p className="title">Size:</p> 
              <p className="product-information">20xm x 10cm</p> 
            </div> 
            </div> 
            </div> ) }
