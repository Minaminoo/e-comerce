...
const product14 = () => {
  ...
  const cartAmount = cartItem[14];
  return ( <div> 
    <h1 className="product-head">Oak Spanish Chair</h1> 
    <div className="product"> 
    <div><img src="/images/products/Oak Spanish Chair.png" alt="Little Armchair Sheepskin" className="product-image product-image-mobile" />
    </div> 
    <div className="product-inf"> 
      ...
      <button className="addToCart-btn" onClick={() => addToCart(14)}> ADD TO CART{cartAmount > 0 && <>({cartAmount})</>}</button> 
