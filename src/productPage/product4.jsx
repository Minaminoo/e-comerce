...
const product4 = () => {
  ...
  const cartAmount = cartItem[4];
        return ( <div> 
          <h1 className="product-head">Pulp Unit-5 Compartements</h1> 
          <div className="product"> 
          <div><img src="/images/products/Pulp Unit-5 Compartements.jpg" alt="Little Armchair Sheepskin" className="product-image product-image-mobile" />
          </div> 
          <div className="product-inf"> 
            ...
            <button className="addToCart-btn" onClick={() => addToCart(4)}> ADD TO CART{cartAmount > 0 && <>({cartAmount})</>}</button> 
            ...
            <div className="product-sub-test"> 
              ...
              <p className="product-information">45kg</p> </div> 
            <div className="product-sub-test"> <p className="title">Size:</p> 
              <p className="product-information">250xm x 60cm</p> 
            </div> 
            </div> 
            </div> ) }
