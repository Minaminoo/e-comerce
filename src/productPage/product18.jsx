...
const product18 = () => {
  ...
  const cartAmount = cartItem[18];
  return ( <div> 
    <h1 className="product-head">Mat Black Lamp</h1> 
    <div className="product"> 
    <div><img src="/images/products/Mat Black Lamp.png" alt="Little Armchair Sheepskin" className="product-image product-image-mobile" />
    </div> 
    <div className="product-inf"> 
      ...
      <div className="btn-div">
        <button className="addToCart-btn" onClick={() => addToCart(18)}> ADD TO CART{cartAmount > 0 && <>({cartAmount})</>}</button> 
      ...
      <div className="product-sub-test"> <p className="title">Size:</p> 
        <p className="product-information">20cm x 15cm</p> 
      </div> 
      </div> 
      </div> ) }
